...
import {disposeContext, initContext, logEndAndClose, logErrorAndStop, runDump, runPlan, runRestore,} from './lib';
...
program
    ...
    .option('-u, --directus-url <directusUrl>', 'Directus URL. Can also be set via DIRECTUS_URL env var')
    .option('-t, --directus-token <directusToken>', 'Directus access token. Can also be set via DIRECTUS_TOKEN env var')
    .option(
        '--no-split',
