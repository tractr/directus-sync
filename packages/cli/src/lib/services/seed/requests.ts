import { DirectusUser, readItems, readUsers, RegularCollections, Query, createItem, createUser, updateItem, updateUser, deleteItem, deleteUser } from "@directus/sdk";
...
export function updateOne(collection: string, id: DirectusId, item: Partial<AnyItem> ) {
    if (!isDirectusCollection(collection)) {
